...
public class MemeAdapter extends RecyclerView.Adapter<MemeAdapter.MyViewHolder> {
    ...
    public MemeAdapter(List<Meme> memes, Context context, OnClickListener onClickListener) {
        this.context = context;
        this.memes = memes;
        this.onClickListener = onClickListener;
    }
    public MemeAdapter(List<Meme> memes, Context context, OnClickListener onClickListener, String layout) {
        this.context = context;
        this.memes = memes;
        this.onClickListener = onClickListener;
        this.layout = layout;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view;
        if (layout == "meme_swipe_card") {
            view = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.meme_swipe_card,
                    parent,
                    false
            );
        } else if (layout == "meme_row_card") {
            view = LayoutInflater.from(parent.getContext()).inflate(
